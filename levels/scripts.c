...
const LevelScript level_main_scripts_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_MARIO_IDLE,              mario_idle_geo),
    LOAD_MODEL_FROM_GEO(MODEL_MARIO_JUMP,              mario_jump_geo),
    LOAD_MODEL_FROM_GEO(MODEL_MARIO_FALL,              mario_fall_geo),
    LOAD_MODEL_FROM_GEO(MODEL_MARIO_BACKWARDS,         mario_run_b_geo),
    LOAD_MODEL_FROM_GEO(MODEL_MARIO_FORWARDS,         mario_run_f_geo),
    LOAD_MODEL_FROM_GEO(MODEL_MARIO_RIGHT,         mario_run_r_geo),
    LOAD_MODEL_FROM_GEO(MODEL_MARIO_LEFT,         mario_run_l_geo),
